...
test('should display Argos battery fill when color_argo set', async () => {
  render(<Vehicle {...props} colorArgo="st27" />)
...
test('should render planktivore body and LM/HM labels when textLM and textHM are provided', async () => {
  render(<Vehicle {...props} textLM="125.6" textHM="1.9" />)
...
test('should render planktivore body when only textLM is provided', async () => {
  render(<Vehicle {...props} textLM="222.9" />)
  expect(screen.queryByLabelText('planktivore body')).toBeInTheDocument()
...
test('should display ROI time-ago on the planktivore housing when provided', async () => {
  render(<Vehicle {...props} textLM="125.6" textRoiAgo="1h 41m ago" />)
...
test('should apply whitebeam class to white beam LED when provided', async () => {
  render(<Vehicle {...props} textLM="125.6" colorWhitebeam="whitebeam" />)
  expect(screen.queryByLabelText('white beam')).toHaveClass('whitebeam')
})

test('should apply redled class to red LED indicator when provided', async () => {
  render(<Vehicle {...props} textLM="125.6" colorRedled="redled" />)
  expect(screen.queryByLabelText('red led')).toHaveClass('redled')
})
