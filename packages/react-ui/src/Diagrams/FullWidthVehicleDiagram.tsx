...
export const FullWidthVehicleDiagram: React.FC<FullWidthVehicleDiagramProps> =
  ({
    className,
    style,
    status,
    ...
    const waveTransform = `translate(-200, ${
    ...
    const wavePath = `M0,${waveOffset} ${new Array(numberOfWaves)
      ...
      .reduce((a, _, i) => {
        ...
        return `${a} c${start},${curveHeight} ${end},${
          curveHeight + 20
        } ${end},0`
    ...
    return (
      <div
        className={clsx(
          'relative h-full w-full overflow-hidden p-0',
          className
        )}
        style={style}
