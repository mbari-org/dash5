...
export interface NotConnectedIconProps {
  className?: string
  style?: React.CSSProperties
}

export const NotConnectedIcon: React.FC<NotConnectedIconProps> = ({
  ...
  return (
    <div className={clsx('', className)} style={style}>
      ...
      >
        ...
        <path d="M1 1L25 25" strokeWidth="2" strokeLinecap="round" />
      </svg>
    </div>
  )
}

NotConnectedIcon.displayName = 'Icons.NotConnectedIcon'
