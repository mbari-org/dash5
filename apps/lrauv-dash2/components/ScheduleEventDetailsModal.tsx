    ...
    >
      <div className="space-y-4 text-base text-stone-900">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          {/* Keep Iridium (left) + SBD (right) as a fixed pair so SBD always
              sits in the Status/Event ID column — including timeout rows with
              no MTMSN/MOMSN. */}
          {(event.mtmsn != null ||
            event.momsn != null ||
                    ...
                    <p className="flex items-center gap-1 text-sm uppercase tracking-wide text-stone-500">
                      ...
                      <span className="relative inline-flex align-middle">
                        ...
                        {showIridiumTooltip && (
                          ...
                          >
                            <p className="normal-case">
                              <strong>MTMSN</strong> (Mobile Terminated):
                              Iridium ID assigned to the command sent to the
                              vehicle.
                            </p>
                            <p className="mt-1 normal-case">
                              <strong>MOMSN</strong> (Mobile Originated):
                              Iridium ID of the vehicle&apos;s acknowledgment
                              reply. Present only after the vehicle confirms
                              receipt.
                            </p>
                          </div>
                        )}
